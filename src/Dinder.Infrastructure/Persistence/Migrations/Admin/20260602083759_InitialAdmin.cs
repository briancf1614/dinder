    ...
    public partial class InitialAdmin : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                schema: "admin",
                table: "prompt_catalog",
                columns: new[] { "Id", "Text", "Category", "IsEnabled", "CreatedAt" },
                values: new object[,]
                {
                    { Guid.NewGuid(), "My ideal first date involves…", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "The way to my heart is…", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "I'm looking for someone who…", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "My love language is…", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "A Sunday well spent looks like…", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "My morning routine is…", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "On weekends you'll find me…", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "My favorite travel destination…", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "A fun fact about me is…", "Fun", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "My most useless talent is…", "Fun", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "If I could have any superpower…", "Fun", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "The most spontaneous thing I've done…", "Fun", true, DateTime.UtcNow }
                });

            // ── Seed: Icebreaker Library ──────────────────────────────
            migrationBuilder.InsertData(
                schema: "admin",
                table: "icebreaker_library",
                columns: new[] { "Id", "Text", "Category", "IsEnabled", "CreatedAt" },
                values: new object[,]
                {
                    { Guid.NewGuid(), "What's your go-to karaoke song?", "Funny", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's the most embarrassing thing you've ever eaten?", "Funny", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "If animals could talk, which would be the rudest?", "Funny", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's a hill you're willing to die on?", "Deep", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What book or movie changed your perspective on life?", "Deep", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What does your ideal future look like?", "Deep", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's your favorite way to spend a Friday night?", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's the best first date you've ever been on?", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's your love language?", "Dating", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's the best piece of advice you've ever received?", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's your favorite way to recharge after a long week?", "Lifestyle", true, DateTime.UtcNow },
                    { Guid.NewGuid(), "What's a hobby you've always wanted to pick up?", "Lifestyle", true, DateTime.UtcNow }
                });
