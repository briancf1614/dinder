...
namespace Dinder.Infrastructure.Persistence.Migrations.Moderation
{
    ...
    [Migration("20260602085026_InitialModeration")]
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.AdminAuditLog", b =>
                {
                    ...
                    b.ToTable("audit_log", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.Conversation", b =>
                {
                    ...
                    b.ToTable("conversations", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.DeviceToken", b =>
                {
                    ...
                    b.ToTable("device_tokens", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.IcebreakerLibrary", b =>
                {
                    ...
                    b.ToTable("icebreaker_library", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.MediaFile", b =>
                {
                    ...
                    b.ToTable("media_files", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.Notification", b =>
                {
                    ...
                    b.ToTable("notifications", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.PhotoReview", b =>
                {
                    ...
                    b.ToTable("photo_reviews", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.ProfilePhoto", b =>
                {
                    ...
                    b.ToTable("profile_photos", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.ProfilePreference", b =>
                {
                    ...
                    b.ToTable("profile_preferences", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.PromptCatalog", b =>
                {
                    ...
                    b.ToTable("prompt_catalog", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.ToTable("refresh_tokens", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.Subscription", b =>
                {
                    ...
                    b.ToTable("subscriptions", "moderation");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.UserExternalLogin", b =>
                {
                    ...
                    b.ToTable("user_external_logins", "moderation");
                });
                    ...
                    b.OwnsMany("Dinder.Domain.Entities.ProfilePrompt", "Prompts", b1 =>
                        {
                            ...
                            b1.ToTable("profiles", "moderation");
