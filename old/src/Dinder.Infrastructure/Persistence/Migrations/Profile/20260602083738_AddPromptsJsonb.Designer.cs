...
namespace Dinder.Infrastructure.Persistence.Migrations.Profile
{
    ...
    [Migration("20260602083738_AddPromptsJsonb")]
    partial class AddPromptsJsonb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.ProfilePhoto", b =>
                {
                    ...
                    b.ToTable("profile_photos", "profile");
                });
            ...
            modelBuilder.Entity("Dinder.Domain.Entities.UserExternalLogin", b =>
                {
                    ...
                    b.ToTable("user_external_logins", "profile");
                });
